  ...
  <div class="primary col-md-8 col-sm-12 col-xs-12">
	<div class="panel panel-primary">
	  <div class="panel-body contentF">
		...
		',0,@$_GET['page'],$page->load('objects_per_page'), 1, @$_GET['id']);
		echo '<nav class="text-center"><ul class="pagination">'.$img->pagination(' <li><a href="'.$rewrite->categories(@$_GET['id'],@$_GET['title'],'#').'">«</a></li> ',' <li><a href="'.$rewrite->categories(@$_GET['id'],@$_GET['title'],'#').'">#</a></li> ', ' <li class="active disabled"><a>#</a></li> ', ' <li><a href="'.$rewrite->categories(@$_GET['id'],@$_GET['title'],'#').'">»</a></li> ',$page->load('objects_per_page'),0,@$_GET['page'],1,@$_GET['id']).'</ul></nav>';
		?>
	   </div>
	</div>
  </div> <!-- END col-md-8-->
