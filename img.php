	  ...
	  <div class="panel-body contentF">
		...
		<div class="shared">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-primary">
						<a href='.$urlimg.' download="#TITLE#-www.CartelesCreativos.com.png" title="Descargar el Cartel: #TITLE#" class="btn btn-primary btn-block"><span class="fa fa-download"></span> Descargar Cartel</a> 
					</div>
				</div>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-primary">
