  ...
  <div id="content">
	<!-- Begin Block -->
	  <div class="primary col-md-8 col-sm-12 col-xs-12 contentF">
	  	<div class="panel panel-primary">
			<div class="panel-heading">
			    <h3 class="panel-title"><span class="fa fa-search"></span> Buscar Carteles</h3>
			</div>
		  <div class="panel-body">
				<form class="form-horizontal" action="<?php echo $rewrite->search; ?>" method="get">
					<div class="form-group">
						<div class="col-sm-12">
							<input type="text" class="form-control" id="buscarCartel" placeholder="¿Que desea buscar?" name="s"<?php echo (isset($_GET['s'])?' value="'.htmlspecialchars(strip_tags($_GET['s'])).'"':''); ?>>
						</div>
					</div>
					<button type="submit" value="Buscar" class="btn btn-primary center-block">Buscar</button>
				</form>
		  </div>
		</div>
	...
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title"><span class="fa fa-search-plus"></span> Resultado de la busqueda!</h3>
	  </div>
	  <div class="panel-body">
		<div class="block">
		...
		'.($page->load('object_title')?'<h2 class="titulo"><a href="'.$rewrite->img("#ID#","#REWRITE-TITLE#").'" title="#TITLE#">#TITLE#</a></h2>':'').'
		  ...
		  </div> <!-- END panel-body contentF -->
		</div> <!-- panel panel-primary -->

		',@$_GET['s'],@$_GET['page'],$page->load('objects_per_page'));
		echo '<nav class="text-center"><ul class="pagination">'.$img->searchPagination(' <li><a href="?s='.@$_GET['s'].'&amp;page=#">&laquo;</a></li> ',' <li><a href="?s='.@$_GET['s'].'&amp;page=#">#</a></li> ', ' <li class="active disabled"><a>#</a></li> ', ' <li><a href="?s='.@$_GET['s'].'&amp;page=#">&raquo;</a></li> ',$page->load('objects_per_page'),@$_GET['page'],@$_GET['s']).'</ul></nav>';
		?>
